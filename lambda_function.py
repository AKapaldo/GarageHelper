...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to Garage Helper. Which vehicle would you like oil info for?"
...
class OilIntentHandler(AbstractRequestHandler):
    """Handler for Oil Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
    ...
    def handle(self, handler_input):
        ...
        speak_output = "For a {}, {}.".format(vehicle, useoil)
